            ...
            <div class="modal-body">
                <form id="form-autores">
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            {!! Form::label('nivel', 'Nivel:', array('class' => 'form-label')) !!}
                            {!! Form::select('nivel', $selects[6], null,['class'=>'form-control', 'placeholder'=>'Selecciona tipo de autor', "id" => "select-nivel"]) !!}
                        </div>
                    </div>
        ...
        autores.push(
            {
                ...
                autor: "{{$item->name}}",
                nivel: "{{$item->nivel->valor}}",
                nivel_autor_id: "{{$item->nivel->id}}",
