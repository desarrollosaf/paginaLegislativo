                                ...
                                <div class="card-shadow-hover position-relative rounded-4 overflow-hidden h-100">
                                    <a style="color: #ffffff; text-decoration: none;" target="_blank" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        <figure class="mb-0 position-absolute h-100 w-100"><img
                                                src="https://legislativoedomex.gob.mx/storage/img/fotos/banners/Foro Ley Movilidad.gif"
                                                {{--                                                src="{{asset("storage/img/fotos/banners/Banner Consulta Discapacidad.gif")}}"--}}
                                                alt="" class="position-absolute h-100 w-100"></figure>
                                        <div class="position-absolute bottom-0 p-16 p-lg-24 text-white">
                                            {{--                                        <h4>Consulta a las personas con discapacidad</h4>--}}

                                            {{--                                            <h4  href="https://legislacion.legislativoedomex.gob.mx/convocatorias/12" class="text-dark">--}}
                                            {{--                                                ¡Abrir!</h4>--}}
                                            <a href="https://legislacion.legislativoedomex.gob.mx/convocatorias/12" > <h4 class="text-dark">
                                                    ¡Abrir!</h4></a>
                                        </div>
                                    </a>
                                    ...
                                    <div class="modal fade" id="exampleModal" tabindex="-1"  aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-xg" style="opacity: .8;
filter: alpha(opacity=80);">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <embed src="https://legislativoedomex.gob.mx/storage/img/fotos/banners/03_Foro_20,1x20,2cm.jpg" frameborder="0" width="100%" height="600px">
                                                </div>
                        ...
                        @if($key == 7)
                            <div class="col-12 col-lg-4">
                                <div class="card-shadow-hover position-relative rounded-4 overflow-hidden h-100">
                                    <a href="https://legislacion.legislativoedomex.gob.mx/convocatorias/11"
                                       style="color: black; text-decoration: none;" target="_blank">
                                        <figure class="mb-0 position-absolute h-100 w-100"><img
                                                src="{{asset("/storage/images/Banner rec docente.svg")}}"
                                                alt="" class="position-absolute h-100 w-100"></figure>
                                        <div class="position-absolute bottom-0 p-16 p-lg-24 text-white">
                                            <h4 class="text-dark">
                                                ¡Conoce a las ganadoras y ganadores!</h4>
                                        </div>
                                    </a>
